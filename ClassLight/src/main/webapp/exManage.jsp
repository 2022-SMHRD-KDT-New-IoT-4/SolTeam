        ...
        <div class="content-wrapper">
          ...
          <div>
            ...
            <!-- <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split"
              ...
              id="dropdownMenuSplitButton1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <option class="dropdown-item" href="#" style="text-align: left; color:white">JAVA</option>
                <option class="dropdown-item" href="#" style="text-align: left; color:white">HTML/CSS</option>
                <option class="dropdown-item" href="#" style="text-align: left; color:white">DataBase</option>
                <option class="dropdown-item" href="#" style="text-align: left; color:white">Arduino</option>
                <option class="dropdown-item" href="#" style="text-align: left; color:white">JavaScript</option>
                <option class="dropdown-item" href="#" style="text-align: left; color:white">JSP/Servlet</option>
              </select>
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-primary">제목/내용 검색</button>
