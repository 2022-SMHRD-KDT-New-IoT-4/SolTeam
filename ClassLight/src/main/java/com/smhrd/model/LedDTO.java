...
public class LedDTO {
	...
	public LedDTO(String control_seq, Integer red_led, Integer orange_led, Integer green_led, String student_id,
			Integer serial_no) {
		super();
	...
	// db에 넣을 정보
	public LedDTO(Integer red_led, Integer orange_led, Integer green_led, Integer serial_no) {
		super();
		this.red_led = red_led;
		this.orange_led = orange_led;
		this.green_led = green_led;
